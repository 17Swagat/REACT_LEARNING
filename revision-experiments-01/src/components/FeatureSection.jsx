...
export default function FeatureSection() {
    return <section className="flex flex-col text-center">
        ...
        <h2 className="font-semibold text-3xl laptop:text-4xl smdesktop:text-5xl px-0.5">
        ...
        <div className="bg-transparent px-5 py-10 flex flex-col items-center sm:items-stretch  gap-y-2.5 rounded-2xl lgphone:flex-row lgphone:flex-wrap lgphone:gap-x-2.5 smtablet:gap-x-4 lgtablet:gap-x-4.5 lgtablet:gap-y-4.5 lgphone:justify-center">
            {features.map((item) => {
                return (<div key={item.text} className="w-[80vw] bg-gradient-to-br from-blue-800 to bg-purple-600 p-2 rounded-2xl overflow-hidden lgphone:w-[40%] lgtablet:w-[30%] smdesktop:px-5 smdesktop:py-1">
                    {/* Heading */}
                    <div className="bg-gradient-to-br from-blue-700 to bg-purple-600  rounded-2xl flex justify-center items-center gap-2 p-1.5">
